...
data = pandas.read_csv('compare_faster_3.csv')
...
#print X.shape
#print y.shape
model = Earth(max_degree=5,max_terms=50,thresh=0.0001,penalty=4,xlabels=['m','n','forward_iterations','pyearth','earth','logm']).fit(X,y)
